    ...
    <body> 
        ...
        <!--         create account form -->
                ...
                <div class="login__box">
                    ...
                    <input type="email" placeholder="email" class="login__input" name = "email" id = "joinEmail">
                </div>
                
                <div class="login__box">
                    <i class='bx bx-lock login__icon'></i>
                    <input type="password" placeholder="password" class="login__input" name = "password" id = "joinPassword" >
                </div>
                
                <input type="submit" value="Sign Up" class="login__button1 joinbutton" />
